...
import { renderToString } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/node_modules/source-map/source-map.js';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/.data/kv"}));
...
const rootDir = "C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"title":"House Viewer"};
...
const _qYxMXPFhsXdyEx09HDOktguT_RK7yZFNF2x9pr8iRDY = (nitroApp) => {
...
const _329jYx = eventHandler((event) => {
...
const getClientManifest = () => import('file://C:/Users/deyan.marzev/source/repos/DeyanTestProject/HouseViewer/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_5ICYms = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_JL6C8e = () => Promise.resolve().then(function () { return _guid__put$1; });
const _lazy_viv3Ze = () => Promise.resolve().then(function () { return sync_post$1; });
const _lazy_MXlUJY = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_q1gFZ1 = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_9LNYEO = () => Promise.resolve().then(function () { return clear_delete$1; });
const _lazy_Kun70x = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_svShEe = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_epkBMU = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _329jYx, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/login', handler: _lazy_5ICYms, lazy: true, middleware: false, method: "post" },
  { route: '/api/elements/:guid', handler: _lazy_JL6C8e, lazy: true, middleware: false, method: "put" },
  { route: '/api/elements/sync', handler: _lazy_viv3Ze, lazy: true, middleware: false, method: "post" },
  { route: '/api/items/:id', handler: _lazy_MXlUJY, lazy: true, middleware: false, method: "delete" },
  { route: '/api/items/:id', handler: _lazy_q1gFZ1, lazy: true, middleware: false, method: "put" },
  { route: '/api/items/clear', handler: _lazy_9LNYEO, lazy: true, middleware: false, method: "delete" },
  { route: '/api/items', handler: _lazy_Kun70x, lazy: true, middleware: false, method: "get" },
  { route: '/api/items', handler: _lazy_svShEe, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_epkBMU, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_epkBMU, lazy: true, middleware: false, method: undefined }
];
...
const sign = (payloadPart, secret) => crypto$1.createHmac("sha256", secret).update(payloadPart).digest("hex");
const createToken = (email, secret, ttlMs = 1e3 * 60 * 60) => {
...
const verifyToken = (token, secret) => {
  ...
  if (!crypto$1.timingSafeEqual(expectedBuf, sigBuf)) return null;
  return payload;
};
const requireAuth = (event) => {
  const authHeader = event.node.req.headers["authorization"];
  const token = Array.isArray(authHeader) ? authHeader[0] : authHeader;
  const bearer = (token == null ? void 0 : token.startsWith("Bearer ")) ? token.slice(7) : token || null;
...
const normalizeSyncInput = (input) => ({
  ...
  softwareOriginator: input.softwareOriginator === void 0 ? void 0 : normalizeText(input.softwareOriginator)
});
const normalizeUpdateInput = (input) => ({
  yearAdded: input.yearAdded === void 0 ? void 0 : normalizeText(input.yearAdded),
  softwareOriginator: input.softwareOriginator === void 0 ? void 0 : normalizeText(input.softwareOriginator),
  comment: input.comment === void 0 ? void 0 : normalizeText(input.comment)
});
const elementStore = {
  async list() {
    await ensureSchema();
...
const _guid__put$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: _guid__put
}, Symbol.toStringTag, { value: 'Module' }));

const toSyncInput = (input) => ({
...
const sync_post = defineEventHandler(async (event) => {
  ...
  const elements = body.elements.map(toSyncInput).filter((element) => element.guid.length > 0);
  if (!elements.length) {
    return { elements: [] };
  }
...
const itemStore = {
  ...
  async add(input) {
    ...
    const record = {
      ...
      url: input.url || "",
      dateAdded: input.dateAdded || (/* @__PURE__ */ new Date()).toISOString().slice(0, 10),
      rooms: input.rooms || [],
